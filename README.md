...
- 💸 Optional x402 support through static metadata and a Cloudflare Worker
  gateway.
...
The current public access path is still x402 payment. The static
OAuth/OIDC documents are discovery metadata; this repository does not
issue bearer tokens or manage user accounts by default.
...
[GitHub Issues](https://github.com/zbzailabs/blog/issues).
